...
- (UIColor *)draw
{
    ...
    [[[NotificationManager alloc] init]creatLocalNotificationWithshadowLineHeight:shadowLineHeight entityLineHeight:entityLineHeight date:self.kLineModel.Date];
    return strokeColor;
}
